...
for(var i = 0; i < 1000; i++) {
    ...
    var tags = []
    if(faker.random.number(10) > 3){//chance of having tags 70%
    ...
    var book = {
        ...
        storage_identifier: faker.random.words(3).split(' ').join('_') + '/' +filename,
...
fs.writeFile(__dirname + '/1000_books.json',  JSON.stringify(all_books, null, 4), function() {
