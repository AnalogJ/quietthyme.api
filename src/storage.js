...
StorageHandler.router = GlobalHandler.wrap(function(event, context, cb) {
  ...
  else if (event.pathParameters.action == 'prepare/book' && event.httpMethod == 'POST') {
    StorageHandler.prepare_book(event, context, cb);
  }
  else if (event.pathParameters.action == 'prepare/cover' && event.httpMethod == 'POST') {
...
StorageHandler.link = function(event, context, cb) {
...
StorageHandler.prepare_book = function(event, context, cb) {
...
StorageHandler.prepare_cover = function(event, context, cb) {
  // this function will create the Author folder for this book, in storage_type specfied
...
StorageHandler.download = function(event, context, cb) {
