...
describe('ParseExternalService', function() {
  ...
  describe('#parse_goodreads_book_details()', function() {
      ...
      goodreads_book_basic = {
        GoodreadsResponse: {
          ...
          book: [
            {
              id: ['11045423'],
              title: ['Scholar (Imager Portfolio, #4)'],
              isbn: [''],
              isbn13: ['9780765329554'],
              asin: [''],
              image_url: [
              ...
              work: [
                {
                  ...
                  original_title: ['Scholar (Imager Portfolio, #4)'],
                  rating_dist: ['4:112|5:85|3:50|1:2|2:7|total:256'],
                  ratings_count: [
                    {
                      _: '1382',
                      $: {
              ...
              url: ['https://www.goodreads.com/book/show/11045423-scholar'],
              link: ['https://www.goodreads.com/book/show/11045423-scholar'],
              authors: [
                {
                  author: [
                    {
                      ...
                      average_rating: ['3.92'],
                      ratings_count: ['104731'],
                      text_reviews_count: ['2552'],
                    },
                  ],
                },
              ],
              ...
              book_links: [
                {
                  book_link: [
                    ...
                    },
                    {
                      id: ['3928'],
                      name: ['Target.com'],
                      link: ['https://www.goodreads.com/book_link/follow/3928'],
                    },
                    {
                      id: ['1602'],
                      name: ['Google Play'],
                      link: ['https://www.goodreads.com/book_link/follow/1602'],
                    },
                    {
                      id: ['7'],
                      name: ['IndieBound'],
              ...
              similar_books: [
                {
                  book: [
                    {
                      id: ['6632027'],
                      title: ['Tracato (A Trial of Blood & Steel, #3)'],
                      isbn: ['0733624189'],
                      isbn13: ['9780733624186'],
                      small_image_url: [
                    ...
                    {
                      id: ['7107573'],
                      title: ['City of Night (The House War, #2)'],
                      isbn: ['075640598X'],
                    ...
                    {
                      id: ['13096215'],
                      title: ['The Straits of Galahesh (Lays of Anuskaya, #2)'],
                      isbn: ['1597803499'],
                      isbn13: ['9781597803496'],
                      small_image_url: [
                    ...
                    {
                      id: ['7854686'],
                      title: ['The Daemon Prism (Collegia Magica, #3)'],
                      isbn: [''],
                      isbn13: [''],
                      small_image_url: [
                    ...
                    {
                      id: ['11217124'],
                      title: ['Dancing With Eternity'],
                      isbn: ['1603818103'],
                      isbn13: ['9781603818100'],
                      small_image_url: [
                    ...
                    {
                      id: ['137624'],
                      title: ['Weavers of War (Winds of the Forelands, #5)'],
                      isbn: ['0765312468'],
                      isbn13: ['9780765312464'],
                      small_image_url: [
                    ...
                    {
                      id: ['8512555'],
                      title: ['Spellbound (Spellwright, #2)'],
                      isbn: ['0765356598'],
                      isbn13: ['9780765356598'],
                      small_image_url: [
                    ...
                    {
                      id: ['16037931'],
                      title: ['Child of the Sword (The Gods Within, #1)'],
                      isbn: [''],
                      isbn13: [''],
                      small_image_url: [
                    ...
                    {
                      id: ['20627073'],
                      title: ['The Child Prince (The Artifactor #1)'],
                      isbn: ['0991039521'],
                      isbn13: ['9780991039524'],
                      small_image_url: [
                    ...
                    {
                      id: ['599217'],
                      title: ['Unto the Breach (Paladin of Shadows, #4)'],
                      isbn: ['1416509402'],
                      isbn13: ['9781416509400'],
                      small_image_url: [
                        'https://s.gr-assets.com/assets/nophoto/book/50x75-673c574e721a5d4c3fd6e25b74d42bf2.png',
                      ],
                      image_url: [
                    ...
                    {
                      id: ['10201356'],
                      title: ['Debris (The Veiled Worlds, #1)'],
                      isbn: ['085766154X'],
                      isbn13: ['9780857661548'],
                      small_image_url: [
    ...
    it('Should correctly parse book', function() {
      var parsed_data = ParseExternalService.parse_goodreads_book_details(
        goodreads_book_basic
      );
      ...
      parsed_book.short_summary.should.eql(
        'Hundreds of years before the time of Imager, the continent of Lydar is fragmented.  Years of war have consolidated five nations into three — Bovaria, Telaryn, and Antiago. Quaeryt is a scholar and a friend of Bhayar, the young ruler of Telaryn. Worried about his future and the escalating intrigues in Solis, the capital city, Quaeryt persuades Bhayar to send him to Tilbor, conquered ten years earlier by Bhayar’s father, in order to see if the number and extent of occupying troops can be reduced so that they can be re-deployed to the border with warlike Bovaria.<br><br>Quaeryt has managed to conceal the fact that he is an imager, since the life expectancies of imagers in Lydar is short. Just before Quaeryt departs, Bhayar’s youngest sister passes a letter to the scholar-imager, a letter that could well embroil Quaeryt in the welter of court politics he had hoped to leave behind. On top of that, on his voyage and journey to Tilbor he must face pirates, storms, poisonings, attempted murder, as well as discovering the fact that he is not quite who he thought he was. To make it all worse, the order of scholars to which he belongs is jeopardized in more ways than one.'
      );
      ...
      parsed_book.image.identifier.should.eql(
        'https://images.gr-assets.com/books/1316731170l/11045423.jpg'
      );
    });
  });
  ...
  describe('#parse_goodreads_search_results()', function() {
    ...
    before(function() {
              ...
              results: [
                {
                  work: [
                    {
                      books_count: [{ _: '16', $: { type: 'integer' } }],
                      id: [{ _: '4693480', $: { type: 'integer' } }],
                      original_publication_day: [
                        { _: '17', $: { type: 'integer' } },
                      ],
                      original_publication_month: [
                      ...
                      ratings_count: [{ _: '4011', $: { type: 'integer' } }],
                      text_reviews_count: [
                        { _: '250', $: { type: 'integer' } },
                      ],
                      average_rating: ['3.98'],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '4643301', $: { type: 'integer' } }],
                          title: ['Imager (Imager Portfolio, #1)'],
                          author: [
                            {
                              id: [{ _: '1301649', $: { type: 'integer' } }],
                              name: ['L.E. Modesitt Jr.'],
                            },
                          ],
                          image_url: [
                    ...
                    {
                      books_count: [{ _: '10', $: { type: 'integer' } }],
                      id: [{ _: '15966126', $: { type: 'integer' } }],
                      original_publication_day: [
                      ...
                      ratings_count: [{ _: '1382', $: { type: 'integer' } }],
                      text_reviews_count: [{ _: '90', $: { type: 'integer' } }],
                      average_rating: ['4.07'],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '11045423', $: { type: 'integer' } }],
                          title: ['Scholar (Imager Portfolio, #4)'],
                          author: [
                            {
                              id: [{ _: '1301649', $: { type: 'integer' } }],
                    ...
                    },
                    {
                      ...
                      ratings_count: [{ _: '1182', $: { type: 'integer' } }],
                      text_reviews_count: [{ _: '59', $: { type: 'integer' } }],
                      average_rating: ['4.14'],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '13118885', $: { type: 'integer' } }],
                          title: ['Princeps (Imager Portfolio, #5)'],
                          author: [
                            {
                              id: [{ _: '1301649', $: { type: 'integer' } }],
                              name: ['L.E. Modesitt Jr.'],
                          ...
                          image_url: [
                            'https://images.gr-assets.com/books/1344317727m/13118885.jpg',
                          ],
                          small_image_url: [
                            'https://images.gr-assets.com/books/1344317727s/13118885.jpg',
                          ],
                        },
                      ],
                    },
                    {
                      books_count: [{ _: '12', $: { type: 'integer' } }],
                      id: [{ _: '6596460', $: { type: 'integer' } }],
                      original_publication_day: [
                        { _: '12', $: { type: 'integer' } },
                      ],
                      original_publication_month: [
                      ...
                      ratings_count: [{ _: '2664', $: { type: 'integer' } }],
                      text_reviews_count: [{ _: '98', $: { type: 'integer' } }],
                      average_rating: ['4.06'],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '6407550', $: { type: 'integer' } }],
                          title: ["Imager's Challenge (Imager Portfolio, #2)"],
                          author: [
                            {
                              id: [{ _: '1301649', $: { type: 'integer' } }],
                              name: ['L.E. Modesitt Jr.'],
                          ...
                          image_url: [
                            'https://images.gr-assets.com/books/1312055254m/6407550.jpg',
                          ],
                          small_image_url: [
                            'https://images.gr-assets.com/books/1312055254s/6407550.jpg',
                          ],
                        },
                      ],
                    },
                    {
                      books_count: [{ _: '8', $: { type: 'integer' } }],
                      id: [{ _: '7860898', $: { type: 'integer' } }],
                      original_publication_day: [
                        { $: { type: 'integer', nil: 'true' } },
                      ],
                      original_publication_month: [
                      ...
                      ratings_count: [{ _: '2106', $: { type: 'integer' } }],
                      text_reviews_count: [{ _: '95', $: { type: 'integer' } }],
                      average_rating: ['4.08'],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '7199136', $: { type: 'integer' } }],
                          title: ["Imager's Intrigue (Imager Portfolio, #3)"],
                          author: [
                            {
                              id: [{ _: '1301649', $: { type: 'integer' } }],
                              name: ['L.E. Modesitt Jr.'],
                    ...
                    {
                      books_count: [{ _: '7', $: { type: 'integer' } }],
                      id: [{ _: '21455003', $: { type: 'integer' } }],
                      original_publication_day: [
                        { _: '22', $: { type: 'integer' } },
                      ],
                      original_publication_month: [
                      ...
                      ratings_count: [{ _: '922', $: { type: 'integer' } }],
                      text_reviews_count: [{ _: '66', $: { type: 'integer' } }],
                      average_rating: ['4.13'],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '15757055', $: { type: 'integer' } }],
                          title: ["Imager's Battalion (Imager Portfolio, #6)"],
                          author: [
                            {
                              id: [{ _: '1301649', $: { type: 'integer' } }],
                              name: ['L.E. Modesitt Jr.'],
                          ...
                          image_url: [
                            'https://images.gr-assets.com/books/1342560972m/15757055.jpg',
                          ],
                          small_image_url: [
                            'https://images.gr-assets.com/books/1342560972s/15757055.jpg',
                          ],
                        },
                      ],
                    },
                    {
                      ...
                      ratings_count: [{ _: '729', $: { type: 'integer' } }],
                      text_reviews_count: [{ _: '46', $: { type: 'integer' } }],
                      average_rating: ['4.10'],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '16059444', $: { type: 'integer' } }],
                          title: ['Antiagon Fire (Imager Portfolio, #7)'],
                          author: [
                            {
                              id: [{ _: '1301649', $: { type: 'integer' } }],
                              name: ['L.E. Modesitt Jr.'],
                          ...
                          image_url: [
                            'https://images.gr-assets.com/books/1367749501m/16059444.jpg',
                          ],
                          small_image_url: [
                            'https://images.gr-assets.com/books/1367749501s/16059444.jpg',
                          ],
                        },
                      ],
                    },
                    {
                      ...
                      ratings_count: [{ _: '517', $: { type: 'integer' } }],
                      text_reviews_count: [{ _: '47', $: { type: 'integer' } }],
                      average_rating: ['4.07'],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '17910122', $: { type: 'integer' } }],
                          title: ['Rex Regis (Imager Portfolio, #8)'],
                          author: [
                            {
                              id: [{ _: '1301649', $: { type: 'integer' } }],
                              name: ['L.E. Modesitt Jr.'],
                          ...
                          image_url: [
                            'https://images.gr-assets.com/books/1373660829m/17910122.jpg',
                          ],
                          small_image_url: [
                            'https://images.gr-assets.com/books/1373660829s/17910122.jpg',
                          ],
                        },
                      ],
                    },
                    {
                      ...
                      ratings_count: [{ _: '0', $: { type: 'integer' } }],
                      text_reviews_count: [{ _: '0', $: { type: 'integer' } }],
                      average_rating: [{ _: '0.0', $: { type: 'float' } }],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '22238209', $: { type: 'integer' } }],
                          title: [
                            'Madness in Solidar: The Ninth Book of the Imager Portfolio',
                          ],
                          author: [
                            {
                              id: [{ _: '8161250', $: { type: 'integer' } }],
                              name: ['L E Modesitt  Jr'],
                            },
                          ],
                          image_url: [
      ...
      goodreads_search_single = {
        GoodreadsResponse: {
          ...
          search: [
            {
              query: ['Abaddons Gate - S.A. Corey'],
              'results-start': ['1'],
              'results-end': ['1'],
              'total-results': ['1'],
              source: ['Goodreads'],
              'query-time-seconds': ['0.03'],
              results: [
                {
                  work: [
                    {
                      books_count: [{ _: '15', $: { type: 'integer' } }],
                      id: [{ _: '17606564', $: { type: 'integer' } }],
                      original_publication_day: [
                        { _: '1', $: { type: 'integer' } },
                      ],
                      original_publication_month: [
                      ...
                      ratings_count: [{ _: '7293', $: { type: 'integer' } }],
                      text_reviews_count: [
                        { _: '708', $: { type: 'integer' } },
                      ],
                      average_rating: ['4.15'],
                      best_book: [
                        {
                          $: { type: 'Book' },
                          id: [{ _: '16131032', $: { type: 'integer' } }],
                          title: ["Abaddon's Gate (Expanse, #3)"],
                          author: [
                            {
                              id: [{ _: '4192148', $: { type: 'integer' } }],
      ...
      goodreads_search_empty = {
        GoodreadsResponse: {
          ...
          search: [
            {
              query: ['Completely Unreal - S.A. Corey'],
              'results-start': ['1'],
              'results-end': ['0'],
              'total-results': ['0'],
              source: ['Goodreads'],
    ...
    it('Should correctly parse multiple search results', function() {
      var parsed_results = ParseExternalService.parse_goodreads_search_results(
        goodreads_search_array
      );
      ...
      first_result.image_url.should.eql(
        'https://s.gr-assets.com/assets/nophoto/book/111x148-0bc7d2a334eb7b34f3ef3fe4286bcf79.png'
      );
  ...
  describe('#parse_goodreads_search_author()', function() {
    ...
    before(function() {
      goodreads_author_search_result = {
        Request: {
          authentication: 'true',
          key: 'VEjXc5XWMAeIJYoHlqZK8w',
          method: 'api_author_link',
        },
        author: {
          '@': { id: '1301649' },
          name: 'L.E. Modesitt Jr.',
          link:
            'https://www.goodreads.com/author/show/1301649.L_E_Modesitt_Jr_?utm_medium=api&utm_source=author_link',
        },
      };
      goodreads_author_search_empty = {
        Request: {
          authentication: 'true',
          key: 'VEjXc5XWMAeIJYoHlqZK8w',
          method: 'api_author_link',
    ...
    it('Should correctly parse empty author search result', function() {
      var parsed_results = ParseExternalService.parse_goodreads_search_author(
        goodreads_author_search_empty
      );
  ...
  describe('#parse_goodreads_shelves', function() {
    ...
    it('Should correctly parse list of shelves', function() {
      var parsed_results = ParseExternalService.parse_goodreads_shelves(
        goodreads_shelves_response
      );
      parsed_results.should.be.an.Array;
  ...
  describe('#parse_goodreads_shelf_content', function() {
    ...
    before(function(done) {
      var fs = require('fs');
      fs.readFile('./test/fixtures/goodreads_shelf_content.json', function(
        err,
        data
      ) {
    ...
    it('Should correctly parse shelf content', function() {
      var parsed_results = ParseExternalService.parse_goodreads_shelf_content(
        goodreads_shelf_content_response
      );
      parsed_results.should.be.an.Array;
