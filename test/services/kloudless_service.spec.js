...
describe('KloudlessService', function () {
    describe('#folderCreate() @nock', function(){
        it('Should generate a folder on dropbox', function (done) {
            KloudlessService.folderCreate('231987328', 'my-test-folder','root', 'dropbox')
    ...
    describe.skip('#fileUpload() @nock', function(){ //TODO: requests made by the "request" library are not being recorded. skipping.
                        ...
                        objects: [
                            {
                                ...
                                metadata: {
                                    account: 231987328,
                                    ancestors: [ { name: 'Dropbox', id: 'FbOHF9CrtPQkhUlEkquzMdA==' } ],
                                    name: 'my-test-folder',
